		...
		<section class="pages clearfix">
			...
			<div class="content-inner-left">
				...
				<form action="php/contact.php" method="post" class="form contactForm" id="contactForm" style="margin-bottom:0;" novalidate="novalidate">
					...
					<p>
						<input type="text" name="contactName" class="required text-field" id="contactName" placeholder="Your Name*" required="required" />
					</p>
					<p>
						<input type="email" name="contactEmail" class="required text-field" id="contactEmail" placeholder="E-mail*" required="required" />
					</p>
					<p>
						<input type="text" name="contactSubject" class="text-field" id="contactSubject" placeholder="Subject" />
					</p>
					...
					<p style="float:left; clear:both; margin-top:10px;">
						<input type="submit" class="submit submitTheme submitForm" id="submitContact" value="Submit" />
					</p>
				</form>
			</div>
